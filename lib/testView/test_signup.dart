...
class _SignUpState extends State<SignUp> {
  ...
  Widget build(BuildContext context) {
    ...
    //                               ),
    //                               Text(
    //                                   '${snapshot.data.data[first].details.authordetails[second].user.expertexpertisemapping[0].parentexpertise.expertiseName == null ? '' : snapshot.data.data[first].details.authordetails[second].user.expertexpertisemapping[0].parentexpertise.expertiseName}'),
    //                             ],
    //                           ),
    //                         ),
    //                       ],
    ...
    //                         Expanded(
    //                             child: GestureDetector(
    //                                 onTap: () {}, child: Text('See Full Consultation'))),
    ...
    //                         Expanded(
    //                             child:
    //                             GestureDetector(onTap: () {}, child: Text('Ask Dr. a query'))),
    //                       ],
    //                     ),
    //                   ],
    //                 ),
